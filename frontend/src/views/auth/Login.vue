        ...
        <div
            ...
            <form class="space-y-6" action="#" @submit.prevent="handleSubmit">
                <div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                    v-if="authStore.errors" role="alert">
                    ...
                    <div>
                        <span class="font-medium">ตรวจสอบให้แน่ใจว่าเป็นไปตามข้อกำหนดเหล่านี้:</span>
                        <ul class="mt-1.5 list-disc list-inside">
                            <li v-for="(error, index) in authStore.errors" :key="index">{{ error[0] }}</li>
                        </ul>
                    </div>
                </div>
